...
export async function POST(request: NextRequest) {
  try {
    ...
    const { selectedDate, selectedOffice, appointments, generatedBy, timestamp } = showCheckData;
    ...
    const html = `
      ...
      <head>
        ...
        <title>${selectedDate}_${selectedOffice}_Show_Check_Report</title>
        <style>
          @media print {
    ...
    return NextResponse.json({ 
      success: true, 
      html,
      filename: `${selectedDate}_${selectedOffice}_Show_Check_Report`
    });
