...
import { GoogleAuthProvider, onAuthStateChanged, signInWithRedirect, signInWithPopup } from 'firebase/auth';
  ...
  return (
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div className="grid gap-6">
        Uncomment the following lines if you want to use email and password login
